...
class AllCodesignEnergyEnv:
    def __init__(self,agent_idx):
        # データの読み込み
        self.solar_radiation_all = np.load("/home/students1/mantani/IEEE/data/sample_data_pv.npy") 
        self.market_all = pd.read_csv("/home/students1/mantani/IEEE/data/spot_summary_2022.csv", encoding='shift_jis')
