...
class RenewableEnergyEnv:
    def __init__(self):
        ...
        self.solar_radiation = self.solar_radiation_all[4344:4344 + 24*31]
        self.market = pd.read_csv("C:/Users/manta/OneDrive/ドキュメント/IEEE/data/spot_summary_2022.csv", encoding='shift_jis')
        self.market_prices = self.extract_market_prices(self.market,4370,4370 + 24*2*31)
    ...
    def reset(self):
       # パラメータの設定
       self.E_max = max(self.solar_radiation)
       self.P_max = max(self.solar_radiation)
